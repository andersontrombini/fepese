...
@section('conteudo')
    <div class="container pt-3">
        <div class="text-center m-4 pb-2">
            ...
            <div class="alert alert-success no-print" role="alert" id="mensagem_confirmacao">
                Cadastro realizado com sucesso!
                Imprima <a href="#" onclick="window.print()" title="Imprimir">
                    <strong>aqui</strong></a> o seu comprovante
            </div>
        </div>
        ...
        <div class="row text-end no-print">
            <div class="col text-center">
                <a href="/cadastro">
                    <span class="retorno_btn btn">
                        Retornar para inscrições
                    </span>
                </a>
            </div>
        </div>
